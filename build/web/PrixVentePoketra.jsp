...
<div class="content">
    ...
    <form action="PrixVenteController" method="post">
         <h1>Voir liste poketra</h1>
        <p><select aria-placeholder="TypeLook" name="poketra">
          <% for(int j=0 ; j< poketra.length ; j++) {%>
          <option value="<%= poketra[j].getIdPoketra() %>"><%= poketra[j].getNomType() %></option>
         <%  } %>
        </select></p>
        <p><input type="text" placeholder="Prix de Vente" name="prixvente"></p>
